               ...
               <div className="screen__content">
                  <div className="login">
                     <div className="login__field">
                        ...
                        <input placeholder="email" type="text" className="login__input" onChange={changeHandler} name="email" value={bank.email} />
                     </div>
                     <div className="login__field">
                        <i className="login__icon fas fa-lock"></i>
                        <input placeholder="Password" type="password" className="login__input" onChange={changeHandler} name="password" value={bank.password} />
