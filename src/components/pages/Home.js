            ...
            <body className="flex-col">
                <div className="flex-col column">
                    ...
                    <div className=" flex-column user-info-wrapper">
                        <div className="user-info"><h1>View Wallet?</h1></div>
                        <div className="user-info"><h2>View converter?</h2></div>
                        <div className="user-info"><h3>View profile?</h3></div>
                        <div className="user-info"><h4>login?</h4></div>
                    </div>
                </div>
